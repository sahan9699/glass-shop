...
<body>
    <header>
        <nav class="nav collapsible">
            <a class="nav__brand" href="/"><img src="images/logo.png" alt="" width="40" /></a>
            <!-- <svg class="icon icon--white nav__toggler">
          <use xlink:href="images/sprite.svg#menu"></use>
        </svg> -->
            <span class="icon nav__toggler">
    ...
    <section class="block block--dark block--skewed-left hero">
        <div class="container grid grid-col-2">
            <header class="block__header hero__content" data-aos="fade-up-right">
                ...
                <a href="#">
                    <div class="button button--accent button--long">Get Start</div>
                </a>
            </header>
            <picture data-aos="fade-up-left">
                ...
                <img class="hero__image" src="images/hero.svg" alt="" />
            </picture>
        </div>
    </section>
    ...
    <section class="block container block-feature">
        ...
        <aretical class="grid grid-col-2 feature">
            <div class="feature__content" data-aos="fade-right">
                <span class="icon-container">
                    <!-- <svg class="icon icon--primary">
              <use xlink:href="images/sprite.svg#easy"></use>
            </svg> -->
                    <svg class="icon icon--primary" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512">
        ...
        <aretical class="grid grid-col-2 feature">
            <div class="feature__content" data-aos="fade-right">
              ...
              <use xlink:href="images/sprite.svg#computer"></use>
                    ...
                    <svg class="icon icon--primary" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
                        <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
        ...
        <aretical class="grid grid-col-2 feature">
            <div class="feature__content" data-aos="fade-right">
              ...
              <use xlink:href="images/sprite.svg#wordpress"></use>
                    ...
                    <svg class="icon icon--primary" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                        <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
    ...
    <section class="block block--dark block--skewed-right block-showcase">
        <header class="block__header">
            <h2>User Frindly Contorl panel</h2>
        </header>
        <div class="container grid grid-col-2">
                ...
                <li>
                  ...
                  <use xlink:href="images/sprite.svg#wordpress"></use>
                        ...
                        <div class="media__body">
                            <h3 class="media__title">Easy Start & Managed Update</h3>
                            <p>
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                                Tempora odit, sint sit, eveniet sunt excepturi officia
                                voluptatibus debitis adipisci eligendi saepe expedita atque
                                labore.
                            </p>
                        </div>
                    </div>
